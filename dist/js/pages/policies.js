...
const PAGES = {
  ...
  terms: (ctx) => ({
    ...
    html: `${header('Terms of <em>service</em>', ctx, `These terms apply when you shop on this website. By placing an order you agree to them.`)}
      ${section('Orders', '<p>Your order is confirmed once your payment has been received and verified. While you pay, we hold the items in your bag for up to 60 minutes. If an item becomes unavailable after you’ve paid, we’ll contact you to offer an alternative or a full refund.</p>')}
