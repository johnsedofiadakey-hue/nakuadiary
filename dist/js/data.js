...
export const products = [
  { id: 'silk-straight', name: 'Silk Straight', category: 'wigs', type: 'HD lace wig', price: 1280, images: photos(stock.straight, stock.editorial), description: 'A low-lustre straight texture for a clean everyday finish.', details: ['Natural black', 'HD lace construction', 'Straight texture'], variants: ['18 inches', '22 inches', '26 inches'] },
  { id: 'body-wave', name: 'Body Wave', category: 'bundles', type: 'Raw hair bundle', price: 620, images: photos(stock.wave, stock.editorial), description: 'Soft, touchable volume with a loose wave that styles easily.', details: ['100g per bundle', 'Low to medium lustre', 'Body-wave texture'], variants: ['16 inches', '20 inches', '24 inches'] },
  { id: 'deep-wave', name: 'Deep Wave', category: 'bundles', type: 'Raw hair bundle', price: 680, images: photos(stock.curls, stock.natural), description: 'Defined texture with a full, softly dramatic profile.', details: ['100g per bundle', 'Defined wave texture', 'Heat style with care'], variants: ['18 inches', '22 inches', '26 inches'] },
  { id: 'water-wave', name: 'Water Wave', category: 'wigs', type: 'HD lace wig', price: 1480, images: photos(stock.hero, stock.editorial), description: 'Fluid, dimensional texture with easy day-to-night movement.', details: ['Natural black', 'HD lace construction', 'Water-wave texture'], variants: ['18 inches', '22 inches', '26 inches'] },
  { id: 'deep-curly', name: 'Deep Curly', category: 'wigs', type: 'HD lace wig', price: 1520, images: photos(stock.curls, stock.natural), description: 'Rich curl definition for an intentionally full silhouette.', details: ['Natural black', 'HD lace construction', 'Deep-curly texture'], variants: ['18 inches', '22 inches', '26 inches'] },
  { id: 'loose-wave', name: 'Loose Wave', category: 'extensions', type: 'Clip-in extensions', price: 720, images: photos(stock.studio, stock.wave), description: 'Relaxed volume and length when you want a different look.', details: ['7-piece set', 'Natural black', 'Loose-wave texture'], variants: ['16 inches', '20 inches', '24 inches'] },
